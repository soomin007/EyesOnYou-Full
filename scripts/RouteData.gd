...
const ALL_ROUTES: Array = [
	...
	},
	{
		...
		"entry_comment": "서버 구역입니다. 드론은 공중, 저격수는 서버 위.",
		"entry_comment_warm": "서버 구역이에요. 드론은 공중, 저격수는 서버 위.",
	...
	},
	{
		...
		"tags": ["도전", "어두운_환경"],
		"veil_comment": "[도전] 통신이 끊깁니다. 안에서는 저도 못 돕습니다. 시간 안에 빠져나오십시오. 맞으면 시간이 깎입니다.",
		"veil_comment_warm": "[도전] 통신이 끊겨요. 안에선 저도 못 도와드리니 시간 안에 빠져나오세요. 맞으면 시간이 깎입니다.",
		"entry_comment": "여기서부터 통신이 끊깁니다. 33초 안에 빠져나오십시오.",
		"entry_comment_warm": "여기서부터 통신 끊겨요. 33초 안에 빠져나오세요.",
	...
	},
	{
		...
		"name": "서버 복도",
		"description": "핵심부로 이어지는 서버 복도. 데이터가 흐르는 만큼 경비도 삼엄하다.",
		"risk": 3,
		"reward_type": "record",
		"hidden": false,
		"unique": false,
		...
		"min_stage": 6, "max_stage": 7,
		"tags": ["전투", "드론", "원거리"],
		"veil_comment": "서버 복도입니다. 드론은 공중, 저격수는 서버 위. 올라가서 같은 높이로 맞서십시오.",
		"veil_comment_warm": "서버 복도예요. 드론은 공중, 저격수는 서버 위. 올라가서 같은 높이로 맞서세요.",
