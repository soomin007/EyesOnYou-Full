...
const BRIEFINGS_BY_BAND: Dictionary = {
	"cold": [
		...
		["심장부 권역에 다시 들어섰습니다. 회수 대상이 가깝습니다.", "이 안에서 그것과 마주칩니다. 준비하십시오."],
	...
	"thaw": [
		...
		["다시 심장부예요. 회수 대상이 가까워요.", "여기서... 그걸 마주쳐요. 마음 단단히 먹어요."],
...
const ACT_ENTRY_BY_BAND: Dictionary = {
	...
	4: {
		...
		"thaw": "다시 심장부예요. 드라이브가 여기 있어요. 그런데... 저 말고도 그걸 보는 눈이 있어요. 요원이 봐줘요.",
