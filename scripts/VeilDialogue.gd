...
const BRIEFINGS_BY_BAND: Dictionary = {
	"cold": [
		...
		["여기가 마지막 구간입니다. 길은 요원이 보십시오. 저는 끝까지 곁에 있겠습니다.", "거의 다 왔습니다. 마지막 판단은 요원에게 맡기겠습니다."],
	],
	"thaw": [
		...
		["마지막이에요. 여기서부턴 요원이 길을 봐 줘요. 저는 곁에 있을게요."],
	],
	"warm": [
		[],
		[],
		...
		[],
		[],
		["시설 안쪽 깊이 왔어요. ...천천히 가도 돼요, 요원.", "여기까지 와 줬네요. 고마워요, 요원."],
		["제가 못 보는 데가 생겨요. 거긴 요원이 봐 줄래요?"],
		["이 앞이 이상해요. 뭔가... 제가 아닌 게 보여요. 곁에 있어 줘요."],
		["여기가 마지막 길목이에요. 거의 다 왔어요, 요원."],
		["따라와요, 그게. 무섭지만... 요원이 있으니까. 같이 가요.", "멈추지 말아요. 잡히면 안 되죠, 우리."],
		["조금만 더요. 요원이 봐 주는 한, 안 놓쳐요."],
		["거의 벗어났어요. 끝까지 같이 가죠."],
		["여기가 그 앞이에요. ...무슨 일이 있어도, 요원 곁에 있을게요."],
		["드라이브가 여기 있어요. 어떻게 할지는... 요원이 정해요. 저는 믿을게요."],
