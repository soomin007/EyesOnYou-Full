...
const BRIEFINGS_BY_BAND: Dictionary = {
	"cold": [
		...
		["핵심부 직전입니다. 무언가... 제 시야에 잡히지 않는 것이 있습니다. 주의하십시오.", "이 안쪽이 이상합니다. 경계하십시오."],
		["마지막 경비선입니다. 여기만 지나면 됩니다."],
		["빠져나온 줄 알았는데, 아직입니다. 추적이 붙었습니다. 계속 움직이십시오.", "멈추지 마십시오. 뒤가 따라옵니다."],
		["추적을 따돌려야 합니다. 은폐물을 활용하십시오.", "이 구역은 노출이 심합니다. 빠르게 통과하십시오."],
		["거의 벗어났습니다. 마지막 추적 구간입니다.", "조금만 더 버티면 됩니다."],
		["심장부 권역에 다시 들어섰습니다. 회수 대상이 가깝습니다.", "여기가 대면의 지점입니다. 준비하십시오."],
	...
	"thaw": [
		...
		["외곽은 거의 지났어요. 이제 시설 안쪽이에요. 여기부터 좀 더 조심해요."],
		["저 문 너머는... 잠깐. 아니에요. 가던 길 가요.", "앞에 뭔가... 아니에요. 제가 잘못 봤어요. 가요.", "방금... 아니에요. 신경 쓰지 말아요. 저도 가끔 이래요."],
		["이 층은 도면이랑 달라요. 저도 처음 봐요.", "이 구역은 오래됐어요. 오래 닫혀 있었고요."],
		["안쪽으로 깊이 들어왔어요. 핵심부가 멀지 않아요.", "경비가 두터워져요. 천천히 가요."],
		["여기부터는 잘 안 보여요. 이쪽은 요원이 봐줘요.", "핵심부 접근로예요. 감시가 촘촘해요."],
		["핵심부 직전이에요. 뭔가... 제가 못 보는 게 있어요. 조심해요.", "이 안이 이상해요. 경계해요."],
		["여기가 마지막 길목이에요. 조금만 더요."],
		["빠져나온 줄 알았는데... 아니에요. 뭔가 따라와요. 계속 움직여요.", "멈추지 말아요. 뒤가 쫓아와요."],
		["따돌려야 해요. 엄폐 쓰면서 가요.", "여긴 노출이 심해요. 빠르게 지나가요."],
		["거의 벗어났어요. 마지막 추적 구간이에요.", "조금만 더 버텨요."],
		["다시 심장부예요. 회수 대상이 가까워요.", "여기가... 대면의 지점이에요. 준비해요."],
		["드라이브가 이 앞이에요. 회수하고, 어떻게 할지 정해요.", "회수 대상 확인했어요. 결정은 요원 몫이에요."],
	...
	"warm": [
		...
		[],
		[],
		["시설 안쪽 깊이 왔어요. ...요원. 천천히 가도 돼요.", "요원. 끝까지 따라와줘서, 고마워요."],
		["제가 못 보는 데가 생겨요. 거긴 요원이 봐줘요."],
		["이 앞이 이상해요. 뭔가... 제가 아닌 게 보여요, 요원. 곁에 있어줘요."],
		["여기가 마지막 길목이에요. 거의 다 왔어요, 요원."],
		["따라와요, 그게. 무섭지만... 요원이 있으니까 괜찮아요.", "멈추지 말아요. 같이 가요."],
		["조금만 더요. 요원이 봐주는 한, 놓치지 않아요."],
		["거의 벗어났어요. 끝까지 같이 가요."],
		["여기가 그 앞이에요. ...무슨 일이 있어도, 요원 곁에 있을게요."],
		["드라이브가 여기 있어요. 어떻게 할지... 요원이 정해요. 저는 믿어요."],
