...
| 철거 구역 · veil | 위에서 잔해가 계속 떨어집니다. 바닥에 그림자가 지면 그 자리를 비키십시오. | |
...
| 서버 복도 방1 · veil | 서버 구역입니다. 서버 위 발판이 유리합니다. 위에서 보고, 위에서 쏘십시오. | |
