...
| record ① | 기록이 비었습니다. 이 길에서 한 칸 되찾을 수 있습니다. | |
| record ② | 다음 실수에 대비해 둡니다. 기록을 채울 수 있는 쪽입니다. | |
| record ③ | 이쪽을 지나면 기록 한 칸이 복구됩니다. | |
...
| warm · record ① | 기록이 비었죠. 이 길에서 한 칸 되찾을 수 있어요. | |
| warm · record ② | 다음 실수에 대비해 두죠. 기록을 채울 수 있는 쪽입니다. | |
| warm · record ③ | 이쪽을 지나면 기록 한 칸이 복구돼요. | |
...
| `_update_risk_reward_panel()` 보상·기록 | [보상 · 기록] 지나면 기록 1칸을 되찾습니다. 가득하면 경험치로 받습니다. | |
...
| 차량 엄폐 방2 · veil | 이 마당은 양쪽에서 포탑이 훑습니다. 엄폐가 등 뒤부터 깎입니다. 머물수록 설 곳이 사라집니다. | |
