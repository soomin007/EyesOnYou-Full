...
| [story_docs.md](story_docs.md) | 인트로 의뢰 문서(INTRO_CONTRACT) · 회수 리드아웃/VEIL 고백 · ??? 방 전량 · ARCTURUS 아카이브 · server_hall 서버 로그 · 14-2 터널 · 재진입 오버레이 | ~131 |
...
|---|---|---|
| Stage.gd | 155 | veil_ingame(29+부록 21) · rival(19) · story_docs(58) · ui(19) |
| RouteData.gd | 198 | briefing_routes(163) · 여러 라인 문자열로 스윕>수록 |
| VeilDialogue.gd | 171 | briefing_routes(107) · story_docs(58) · ui(사망 30+레벨업 12) |
